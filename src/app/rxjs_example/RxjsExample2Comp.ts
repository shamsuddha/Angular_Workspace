...
@Component({
  ...
  template: `
    ...
    <button (click)="click2()">click3</button>
    <button (click)="click3()">click3</button>
    <button (click)="click4()">click3</button>
    <button (click)="click5()">click3</button>
    <button (click)="click6()">click3</button>
    <button (click)="click7()">click3</button>
    <button (click)="click8()">click3</button>
  `,
})
export class RxjsExample2Comp {
  ...
  rajitApi(): Observable<Array<StudentDto>> {
    const t: Observable<Array<StudentDto>> = new Observable((subscriber) => {
      subscriber.next([
        new StudentDto({ id: 4, name: 'name 1' }),
        new StudentDto({ id: 2, name: 'name 2' }),
      ]);
    });
    return t;
